...
local ammunation = {
    ...
    Menu = {
        ...
        ["catégorie 1"] = {
            b = {
                {name = "Pétoire", ask = "~g~17500$", askX = true},
                {name = "Pistolet", ask = "~g~14500$", askX = true},
                {name = "Tazer", ask = "~g~7500$", askX = true},
            }
        },

        ["catégorie 2"] = {
            b = {
                {name = "Couteau", ask = "~g~1250$", askX = true},
                {name = "Batte", ask = "~g~1450$", askX = true},
                {name = "Machette", ask = "~g~2150$", askX = true},
        ...
        ["accessoires"] = {
            b = {
                ...
                {name = "Lampe Torche", ask = "~g~950$", askX = true},
                {name = "Poignée", ask = "~g~700$", askX = true},
                {name = "Silencieux", ask = "~g~650$", askX = true},
            }
        },
    }
}
